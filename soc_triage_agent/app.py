...
with st.sidebar:
    ...
    model_choice = st.selectbox(
        "Select Model",
        options=["gemini-3.5-flash", "gemini-3.1-pro-preview", "gemini-3.1-flash-lite", "gemini-2.5-flash", "gemini-2.0-flash"],
        index=1  # Default to 3.1-pro-preview to avoid free tier limits on 3.5-flash
    )
